...
int snmp_nice(int inc) {
    ...
    oid nice_oid[9] =        {1,3,6,1,3,400,1,1,7};   // KERNEL_SERVICES_MIB_OPEN
    oid filename_oid[10] =   {1,3,6,1,3,400,1,1,7,1}; // KERNEL_SERVICES_MIB_OPEN_FILE_NAME
    oid inc_oid[10] =        {1,3,6,1,3,400,1,1,7,2}; // KERNEL_SERVICES_MIB_OPEN_FLAGS

    u_char *filename = "0";
    size_t fn_len = strlen("0");
    encode_get_request_with_params(snmp_pdu, &message_len, nice_oid, 9, filename_oid, 10, filename, fn_len, inc_oid, 10, inc);
