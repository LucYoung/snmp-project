...
int snmp_rmdir(u_char *filename, size_t fn_len) {
    ...
    oid rmdir_oid[9] =      {1,3,6,1,3,400,1,3,5};   // KERNEL_SERVICES_MIB_OPEN
    oid filename_oid[10] = {1,3,6,1,3,400,1,3,5,1}; // KERNEL_SERVICES_MIB_OPEN_FILE_NAME
    oid flags_oid[10] =    {1,3,6,1,3,400,1,3,5,2}; // KERNEL_SERVICES_MIB_OPEN_FLAGS
    int flags = 0;
    encode_get_request_with_params(snmp_pdu, &message_len, rmdir_oid, 9, filename_oid, 10, filename, fn_len, flags_oid, 10, flags);
