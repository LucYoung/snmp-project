...
int snmp_open(u_char *filename, size_t fn_len, int flags) {
    ...
    oid open_oid[9] =      {1,3,6,1,3,400,1,3,1};   // KERNEL_SERVICES_MIB_OPEN
    oid filename_oid[10] = {1,3,6,1,3,400,1,3,1,1}; // KERNEL_SERVICES_MIB_OPEN_FILE_NAME
    oid flags_oid[10] =    {1,3,6,1,3,400,1,3,1,2}; // KERNEL_SERVICES_MIB_OPEN_FLAGS

    encode_get_request_with_params(snmp_pdu, &message_len, open_oid, 9, filename_oid, 10, filename, fn_len, flags_oid, 10, flags);
