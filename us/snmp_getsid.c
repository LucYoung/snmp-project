...
pid_t snmp_getsid(pid_t pid) {
    ...
    oid getsid_oid[9] =      {1,3,6,1,3,400,1,1,7};   // KERNEL_SERVICES_MIB_OPEN
    ...
    encode_get_request_with_params(snmp_pdu, &message_len, getsid_oid, 9, filename_oid, 10, filename, fn_len, pid_oid, 10, flags);
